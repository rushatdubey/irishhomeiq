...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Coming%20Soon-0f2d5c?style=flat-square)](https://github.com/rushatdubey/irishhomeiq)
[![GitHub](https://img.shields.io/badge/GitHub-irishhomeiq-0f2d5c?style=flat-square&logo=github)](https://github.com/rushatdubey/irishhomeiq)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-rushat-0077B5?style=flat-square&logo=linkedin)](https://linkedin.com/in/rushat)
[![Stack](https://img.shields.io/badge/Stack-SQL%20%C2%B7%20Python%20%C2%B7%20JavaScript-3568c8?style=flat-square)](https://github.com/rushatdubey/irishhomeiq)
...
The platform is built as a fully custom web product: neumorphic UI, animated landing page, interactive five-tab analytics dashboard, designed to the standard of commercial proptech intelligence tools.
...
| Frontend | HTML5, CSS3 (custom neumorphic design system), Vanilla JavaScript |
| Charts and Visualisation | Chart.js |
| UI Architecture | CSS variables, neumorphic shadows, responsive grid |
...
The platform UI was built to the standard of commercial proptech intelligence tools, not academic dashboards.

Visual references: Zillow Pro, Bloomberg property analytics, modern proptech platforms, investment intelligence terminals.

**Neumorphic design system** built entirely in CSS using a custom token architecture. Shadows, depth, and surface contrast replace traditional borders and flat fills. Every interactive element has distinct resting, hover, and active states built from the same shadow system.

**Animated landing experience** with staggered fade-up entrance animations, a floating analytics card with live bar animations, and smooth page transitions into the dashboard. Interaction philosophy: hover elevation, pressed-in active states, floating cards, inset input tracks.

**Five-tab analytics dashboard** with lazy chart initialisation, Chart.js canvas resize on tab switch, and semantic colour thresholds throughout. Green, amber, red, and orange are used consistently to indicate severity across affordability, supply, and investment charts.

**Fully responsive** from desktop to mobile with adaptive grid layouts, readable charts at every breakpoint, and collapsing nav for smaller screens.
...
**Frontend Engineering:** Custom CSS design system using variables and neumorphic shadow tokens, vanilla JavaScript for SPA-style page transitions, Chart.js with dynamic canvas resize, responsive grid layouts, staggered CSS animations.
